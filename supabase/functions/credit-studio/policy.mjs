...
export const MODES=Object.freeze({standard:Object.freeze({credits:1,quality:'medium',label:'Standard',reserveMicros:130000}),detail:Object.freeze({credits:3,quality:'high',label:'Detail',reserveMicros:390000})});
export const MODEL='gpt-image-2.5-sunburst';
export const UUID=/^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i;
export function mode(name){if(!Object.hasOwn(MODES,name))throw Error('invalid_quality');return MODES[name];}
export function contribution(pack,{storeFee=.15,otherReserve=.02,costPerCredit=.13}={}){
...
export function purchaseEvent(e,{appId,environment}={}){
