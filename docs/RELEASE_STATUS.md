...
Privacy Policy and Terms of Use are committed and a GitHub Pages deployment
workflow is included; the public URL must be rechecked after that workflow
completes. Play Console declarations still must match the exact submitted
artifact.
