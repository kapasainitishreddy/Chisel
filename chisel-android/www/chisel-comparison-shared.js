(function(root){
"use strict";
/* Pure local compare/rules. These do not invoke an image model. */
function pickLooks(rows,ids){
...
function briefHTML({style,notes='',maintenance='Discuss with stylist',source,result}){
...
root.ChiselComparePolicy={pickLooks,briefHTML};
})(globalThis);
