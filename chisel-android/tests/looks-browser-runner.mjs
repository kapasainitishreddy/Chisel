...
try{
 ...
 await page.$eval('.cls-saved',n=>n.open=true);await page.waitForSelector('.cls-saved-row button');await page.click('.cls-saved-row button');check('savedLookReopens',await page.$eval('#clsResult',n=>!n.hidden));await page.click('#clsDismiss');
